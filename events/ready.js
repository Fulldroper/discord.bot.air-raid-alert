...
module.exports = async function () {
  ...
  const api = `https://${process.env.GATEWAY_SCREEN_SHOT_API}/${process.env.TOKEN_SCREEN_SHOOT_API}?style=body%7Bbackground:rgb(49,51,56)%20!important;%7D&darkMode=true&url=${process.env.MAP_PAGE}`
  const req = {
    method: 'get',
